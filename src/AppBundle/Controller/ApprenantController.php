...
class ApprenantController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('apprenant/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\ApprenantType', $apprenant);
        ...
        return $this->render('apprenant/new.html.twig', array(
            'apprenant' => $apprenant,
    ...
    public function showAction(Apprenant $apprenant)
    {
        ...
        return $this->render('apprenant/show.html.twig', array(
            'apprenant' => $apprenant,
    ...
    {
        $deleteForm = $this->createDeleteForm($apprenant);
        $editForm = $this->createForm('AppBundle\Form\ApprenantType', $apprenant);
        ...
        return $this->render('apprenant/edit.html.twig', array(
            'apprenant' => $apprenant,
